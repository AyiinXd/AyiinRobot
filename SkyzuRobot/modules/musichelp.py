...
async def awake(event):
  ...
  LUNA += "• /resume atau  - **Untuk melanjutkan musik/video yang sedang ter pause** \n"
  ...
  BUTTON = [[Button.url("☎️ Support", "https://t.me/AyiinXdSupport"), Button.url("📡 Updates", "https://t.me/AyiinSupport")]]
