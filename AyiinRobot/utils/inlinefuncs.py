...
from AyiinRobot import pbot as app
from AyiinRobot import arq
from AyiinRobot.services.keyboard import Ikb
from AyiinRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from AyiinRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from AyiinRobot.services.types import InlineQueryResultCachedDocument
from AyiinRobot.modules.info import get_chat_info, get_user_info
from AyiinRobot.modules.music import download_youtube_audio
from AyiinRobot.utils.functions import test_speedtest
from AyiinRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Ayiin Robot](https://t.me/YinzRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
