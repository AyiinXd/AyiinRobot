...
from AyiinRobot import DRAGONS, dispatcher
from AyiinRobot.modules.disable import DisableAbleCommandHandler
from AyiinRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_pin,
    can_promote,
    connection_status,
...
from AyiinRobot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
from AyiinRobot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from AyiinRobot.modules.log_channel import loggable
from AyiinRobot.modules.helper_funcs.alternate import send_message
...
def setchat_title(update: Update, context: CallbackContext):
    ...
    try:
        ...
        msg.reply_text(text=gs(update.effective_chat.id, "set_chat_title_success").format(html.escape(chat.title)))
    except BadRequest as excp:
        msg.reply_text(f"Error! {excp.message}.")
        return
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    bot.sendMessage(text=gs(update.effective_chat.id, "promote_success").format(html.escape(chat.title)))
...
ADMINLIST_HANDLER = DisableAbleCommandHandler("bonbon", adminlist, run_async=True)
