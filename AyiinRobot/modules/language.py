import itertools
import AyiinRobot.modules.sql.language_sql as sql
...
from AyiinRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from AyiinRobot.language import get_string, get_languages, get_language
...
def set_lang(update: Update, _) -> None:
    ...
    keyb.append(
        [
            InlineKeyboardButton(
                text="Ayiin With Love 💜 ",
                url="https://t.me/YinzRobot",
            )
        ]
    )
