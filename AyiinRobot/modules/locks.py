...
import AyiinRobot.modules.sql.locks_sql as sql
from AyiinRobot.modules.helper_funcs.decorators import ayiincmd, ayiinmsg
from AyiinRobot.modules.sql.approve_sql import is_approved
from AyiinRobot import DRAGONS, LOGGER as log, dispatcher
...
@ayiincmd(command="lock", pass_args=True)
@user_admin
@loggable
@typing_action
...
@ayiincmd(command="unlock", pass_args=True)
@user_admin
@loggable
@typing_action
...
@ayiinmsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
