...
import AyiinRobot.modules.sql.users_sql as sql
...
from AyiinRobot.modules import ALL_MODULES
from AyiinRobot.modules.helper_funcs.chat_status import is_user_admin
from AyiinRobot.modules.helper_funcs.misc import paginate_modules
...
from AyiinRobot.modules.language import gs
...
SEIRA_IMG = "https://telegra.ph/file/21bca0a64032cd5b23b3c.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Contoldisini \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AyiinRobot.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text=gs(chat.id, "about_button"), callback_data="ayiin_"),
                        ],
                        [
...
def ayiin_about_callback(update, context):
    query = update.callback_query
    chat = update.effective_chat
    if query.data == "ayiin_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Admins", callback_data="ayiin_admin"),
                        InlineKeyboardButton(text=gs(chat.id, "notes_button"), callback_data="ayiin_notes"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), callback_data="ayiin_support"),
                        InlineKeyboardButton(text="Credits", callback_data="ayiin_credit"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "source_button"), url="https://t.me/Contoldisini"),
                    ],
                    [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="ayiin_back"),
                    ]
                ]
            ),
        )
    elif query.data == "ayiin_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
                text=gs(chat.id, "pm_start_text").format(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="ayiin_"),
                    ]
                ]
            ),
        )

    elif query.data == "ayiin_notes":
        query.message.edit_text(
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        ayiin_about_callback, pattern=r"ayiin_", run_async=True
    )
