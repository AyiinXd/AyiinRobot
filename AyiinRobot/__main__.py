            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "about_button"), callback_data="ayiin_"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                        ...
                        [
                            InlineKeyboardButton(
                                ...
                                url="t.me/YinzRobot?startgroup=new",
                            ),
                        ],
                    ]
                ),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Admins", callback_data="ayiin_admin"
                        ),
                        InlineKeyboardButton(
                            text=gs(chat.id, "notes_button"),
                            callback_data="ayiin_notes",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "support_chat_link_button"),
                            callback_data="ayiin_support",
                        ),
                        InlineKeyboardButton(
                            text="Credits", callback_data="ayiin_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "source_button"),
                            url="https://t.me/Contoldisini",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "back_button"), callback_data="ayiin_back"
                        ),
                    ],
                ]
            ),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text=gs(chat.id, "back_button"), callback_data="ayiin_"
                        ),
                    ]
                ]
            ),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="AyiinXd", url="https://github.com/AyiinXd"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
